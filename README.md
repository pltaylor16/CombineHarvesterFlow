...
On GPU machines you will then either have to pre or post pip install a CUDA version of jax to run CombineHarvesterFlow on GPU. See the jax documentation for more details. 
